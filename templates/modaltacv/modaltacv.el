...
(defconst resumel-modaltacv-variable-defaults
  '(("COMPILER"                  . "pdflatex")
    ...
    ("AUTHOR_FONT"               . "\\Huge\\mdseries\\upshape")
    ("TITLE_FONT"                . "\\LARGE\\mdseries\\slshape")
    ("SECTION_FONT"              . "\\LARGE")
    ("SUBSECTION_FONT"           . "\\large")
    ...
    ("MODALTACV_COLUMNRATIO"     . "0.6"))
  "Default variable values for the resumel modaltacv template.")
