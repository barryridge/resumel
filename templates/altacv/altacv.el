...
(defconst resumel-altacv-variable-defaults
  '(("COMPILER"                  . "pdflatex")
    ...
    ("TITLE_FONT"                . "\\large\\bfseries")
    ("AUTHOR_FONT"               . "\\Huge\\rmfamily\\bfseries")
    ("SECTION_FONT"              . "\\LARGE\\rmfamily\\bfseries")
    ("SUBSECTION_FONT"           . "\\large\\bfseries")
    ...
    ("ALTACV_COLUMNRATIO"        . "0.6"))
  "Default variable values for the resumel altacv template.")
