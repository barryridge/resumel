...
@@latex:\makecvfooter{November 5, 1955}{Firstname Lastname~~~·~~~Résumé}{\thepage}@@
...
** Programming
{{{tags(Python,Elisp,JavaScript,LaTeX,C++,Java)}}}

** Tools & Technologies
{{{ltags(Emacs,5,Git,4,Docker,3,AWS,2)}}}
...
- Implemented CI/CD pipeline {{{tags(Python,Docker,Git)}}}
{{{vspace(-4.00mm)}}}
@@latex:}@@
@@latex:\\@@
...
{{{vspace(-4.00mm)}}}
- Full-stack development {{{ltags(JavaScript,4,React,3,Node.js,4)}}}
{{{vspace(-4.00mm)}}}
@@latex:}@@
@@latex:\\@@
...
{{{vspace(-4.00mm)}}}
- *Role 1*
  - Role 1 description. {{{tag(\Cplusplus)}}} {{{tag(Python)}}}
- *Role 2*
  - Role 2 description. {{{tag(\Cplusplus)}}} {{{tag(Python)}}}
- *Role 3*
  - Role 3 description. {{{tag(\Cplusplus)}}} {{{tag(Python)}}}
{{{vspace(-4.00mm)}}}
@@latex:}@@
@@latex:\\@@
